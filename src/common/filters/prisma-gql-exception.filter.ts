import { Catch, ConflictException, NotFoundException, BadRequestException, Inject } from '@nestjs/common';
...
export class PrismaGqlExceptionFilter implements GqlExceptionFilter {
  constructor(
    ...
    if (exception instanceof Prisma.PrismaClientKnownRequestError) {
      this.logger.error(`Ошибка при работе с БД (PrismaClientKnownRequestError): ${exception.code} - ${exception.message}`, { exception });
